function eventListener(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}function darkMode(){const e=window.matchMedia("(prefers-color-scheme:dark)");console.log(e.matches),e.matches?(console.log("obscuro"),document.body.classList.add("dark-mode")):(console.log("claro"),document.body.classList.remove("mostrar")),e.addEventListener("change",(function(){e.matches?(console.log("obscuro"),document.body.classList.add("dark-mode")):(console.log("claro"),document.body.classList.remove("dark-mode "))})),botonDarkMode=document.querySelector(".dark-mode-boton"),botonDarkMode.addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}))}
